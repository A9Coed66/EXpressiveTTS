...
from concat_audio import concat_audio_verified, concat_audio_unverified
...
ap.add_argument("-vrf", "--verify", type=bool, default=False)
...
if __name__ == "__main__": 
    ...
    if args['verify']:
        ...
        concat_audio_verified(folder_name)               # Step 5    
    else:
        concat_audio_unverified(folder_name, no_verify=True)
    trans(folder_name)