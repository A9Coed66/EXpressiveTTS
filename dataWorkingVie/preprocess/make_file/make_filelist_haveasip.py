...
def split_train_val_test(write_path, wav_path, mel_path, spk_dict):
    ...
    for mel_file in mel_filelist:
        ...
        spk, basename = mel_file.split('-')[0], mel_file[8:-4]  # remove .npy
    ...
    with open("test_sentence/haveasip_sentence.txt", "w", encoding="utf-8") as file:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="config/HaveASip/preprocess.yaml")
